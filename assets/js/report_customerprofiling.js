...
function loadajaxfunction(string,page,searchstring){
    ...
    $.ajax({
            url: base_url + "report/loadcustomerprofiling",
            type: "post",
            ...
            success: function (response) {
               ...
               Page         = response['PagingList'];
                ...
                $('#dataloadtable tbody').empty();
console.log(response);
                receivedata = response['FreeServiceList'];
                ...
                $("#a_ExportToExcel").attr("href", base_url + "report/customerprofilingexport/?" + datasting  + "&excelfilename=" + excelfilename);        
