$(document).ready(function () {
    ...
    $( "#ReportOrder" ).submit(function( event ) {
        ...
        var string = "DateFrom=" + DateFrom + "&DateTo=" + DateTo + "&CustomerCode=" + CustomerCode + "&ChassisNo=" + ChassisNo + "&ReportType=" + ReportType;
        var savestring = "DateFrom=" + DateFrom + "&DateTo=" + DateTo + "&CustomerCode=" + CustomerCode + "&ChassisNo=" + ChassisNo + "&ReportType=" + ReportType;
        console.log(string);
...
function load(pageno){
 ...
 function loadajaxfunction(string,page,searchstring){
    ...
    datasting = string;                                 
    $.ajax({
            url: base_url + "logistics/loadreceivereport",
            type: "post",
